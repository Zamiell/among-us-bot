...
func commandHelp(command string, args []string, m *discordgo.MessageCreate) {
	...
	msg += "/addcrew                        Add a town win manually"
	msg += "/minuscrew                      Remove a town win manually"
	msg += "/addimp                         Add an impostor win manually"
	msg += "/minusimp                       Remove an impostor win manually"
	msg += "```\n"
	msg += "Info commands:\n"
	msg += "```\n"
